...
class ClassLoader
{
     ...
     * @param array<int, string>|string $paths   The PSR-0 root directories
     ...
     * @param array<int, string>|string $paths   The PSR-4 base directories
     * @param bool                $prepend Whether to prepend the directories
     *
     ...
     *
     * @param string              $prefix The prefix
     * @param array<int, string>|string $paths  The PSR-0 base directories
     *
     * @return void
     */
